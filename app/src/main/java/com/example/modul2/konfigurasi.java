...
public class konfigurasi {
  ...
  //  KOMPUTER DIMANA DATA PHP BERADA
    public static final String
            URL_ADD="http://192.168.1.4/modul2/insert.php";
    public static final String URL_GET_ALL =
            "http://192.168.1.4/modul2/read.php";
    public static final String URL_GET_MHS =
            "http://192.168.1.4/modul2/select.php?id=";
    public static final String URL_UPDATE_MHS =
            "http://192.168.1.4/modul2/update.php";
    public static final String URL_DELETE_MHS =
            "http://192.168.1.4/modul2/delete.php?id=";
